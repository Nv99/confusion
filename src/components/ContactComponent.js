...
const maxlengthnum = (len) => (val) => isNaN(Number(val)) || !(val) || (val.length <= len);
const minlengthnum = (len) => (val) => isNaN(Number(val)) || !(val) || (val.length >= len);
                    ...
                    <div className='col-12 col-md-9'>
                        <Form model="feedback" onSubmit={ (values) => this.handleSubmit(values)} resetOnSubmit = {true}>    
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Mobile Number"
                                    className ="form-control"
                                    validators={{
                                        required,minlengthnum: minlengthnum(10),maxlengthnum: maxlengthnum(10), isNumber
                                    }} />
                                    <Errors
                                        className="text-danger"
                                        model = ".telnum"
                                        ...
                                        messages={{
                                            required: 'Required ',
                                            minlengthnum: 'Must be of 10 characters',
                                            maxlengthnum: 'Must be of 10 characters',
