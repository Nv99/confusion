...
/* reducer function 
    ...
    takes two params
    * action
        # payloads of information that sends data from your application to the store
        # type property (indicates type of action to be performed)
        #payload (data necessary for the action)

    * state 
        ##action usually handled through a switch statement switching on the action type
